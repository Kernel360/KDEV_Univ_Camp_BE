...
public class UserService {
    ...
    /**
     * ✅ 특정 ID의 사용자 닉네임 가져오기 (id 기준으로 변경)
     */
    ...
    /**
     * ✅ 현재 로그인한 사용자 정보 가져오기 (id 기준으로 변경)
     */
    public UserDto getMyUserWithAuthorities() {
        return SecurityUtil.getCurrentId()
                .flatMap(userRepository::findById) // ✅ id 필드 기준 검색
    ...
    /**
     * ✅ 특정 사용자 정보 가져오기 (관리자 전용, id 기준으로 변경)
     */
