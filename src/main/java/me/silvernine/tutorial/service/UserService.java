...
public class UserService {
    ...
    /**
     * ✅ 회원가입 기능 (비밀번호 암호화 후 저장 + 기본 ROLE_USER 추가)
     */
    @Transactional
    public UserDto signup(UserDto userDto) {
        ...
        Authority userAuthority = authorityRepository.findById("ROLE_USER")
                .orElseThrow(() -> new RuntimeException("기본 권한(ROLE_USER)이 존재하지 않습니다."));
        ...
        User user = User.builder()
                ...
                .authorities(Collections.singleton(userAuthority)) // ✅ user_authority에 ROLE_USER 추가
                .build();
